...
class ConsecuenciaAdapter(private val listener: OnItemClickListener.ConsecuenciaListener) :
    RecyclerView.Adapter<ConsecuenciaAdapter.ViewHolder>() {

    private var count = emptyList<Consecuencia>()
    private var countList: ArrayList<Consecuencia> = ArrayList()

    fun addItems(list: List<Consecuencia>) {
        count = list
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(d: Consecuencia, listener: OnItemClickListener.ConsecuenciaListener) = with(itemView) {
        ...
        return object : Filter() {
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                ...
                if (keyword.isEmpty()) {
                    ...
                    val filteredList = ArrayList<Consecuencia>()
                    for (m: Consecuencia in count) {
