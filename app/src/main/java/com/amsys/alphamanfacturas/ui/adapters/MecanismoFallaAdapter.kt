...
class MecanismoFallaAdapter(private val listener: OnItemClickListener.MecanismoFallaListener) :
    RecyclerView.Adapter<MecanismoFallaAdapter.ViewHolder>() {

    private var count = emptyList<MecanismoFalla>()
    private var countList: ArrayList<MecanismoFalla> = ArrayList()

    fun addItems(list: List<MecanismoFalla>) {
        count = list
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(d: MecanismoFalla, listener: OnItemClickListener.MecanismoFallaListener) = with(itemView) {
        ...
        return object : Filter() {
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                ...
                if (keyword.isEmpty()) {
                    ...
                    val filteredList = ArrayList<MecanismoFalla>()
                    for (m: MecanismoFalla in count) {
